					...
					<div id="reviews" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner mt-4">
							<div class="carousel-item text-center active">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Pratik</strong></h5>
							...
							<div class="carousel-item text-center">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Mr. Kapoor</strong></h5>
							...
							<div class="carousel-item text-center">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Parthvi Sinha</strong></h5>
								<h6 class="text-dark m-0">Seo Analyst</h6>
								<p class="m-0 pt-3"> Excellent food. Menu is extensive and seasonal to a particularly high standard. Definitely fine dining. It can be expensive but worth it and they do different deals on different nights so it’s worth checking them out before you book. Highly recommended.</p>
							</div>
						</div>
